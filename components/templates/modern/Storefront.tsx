            ...
            <section id="products" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                {filteredItems.length === 0 ? (
                    <div className="text-center py-20 border-2 border-dashed border-gray-100 rounded-2xl">
                        ...
                        <p className="text-gray-400 uppercase tracking-widest text-xs font-bold mb-6">No matching results for your query</p>
                        <button
                            onClick={() => {
                                setSelectedCategoryId(null)
                                setSearchQuery("")
                            }}
                            className="px-8 py-3 bg-black text-white text-xs font-bold uppercase tracking-widest hover:bg-gray-800 transition rounded-full"
                        >
                            Reset Search
                        </button>
                    </div>
